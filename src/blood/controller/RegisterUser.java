 ...
 */
@WebServlet("/blood.controller.RegisterUser")
public class RegisterUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int status = UsersDao.register(u);
		if (status > 0) {

			response.sendRedirect("userRegistration.jsp?msg=done");

		} else
			response.sendRedirect("userRegistration.jsp?msg=Something Error");
